    ...
    <div class="card-body collapse hide" id="section_{{ $component_id }}">
        <div class="row">
            <div class="col-4">
                ...
                <div class="file_wrap form-group">
                ...
                <div class="form-group" data-for="style1">
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" data-name="content"></textarea>
                </div>
                <div class="form-group">
                    <label for="">Class</label>
                    <input type="text" class="form-control" data-name="class" placeholder="Enter Section Class" value="">
                </div>
            </div>
        </div>
