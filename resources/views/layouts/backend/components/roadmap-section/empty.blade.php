        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" data-name="title" class="form-control" placeholder="Title" value="">
                </div>
                <div class="form-group">
                    <label for="">Description</label>
                    <textarea type="text" data-name="description" class="form-control" placeholder="Description"></textarea>
                </div>
                <hr>
                <div class="form-group" data-name="timelines">
                    <label for="">Timeline</label>
                    <textarea type="text" data-name="timeline" class="form-control" placeholder="Content"></textarea>
                </div>
            </div>
        </div>
    </div>
