    ...
    <div class="card-body collapse hide" id="banner_{{ $component_id }}">
        <div class="row">
            <div class="col-4">
                ...
                <div class="file_wrap">
                    <img src="@if($content->value[0]->image != '')/storage/uploads/{{ $content->value[0]->image }}@else
                        {{ asset('assets/img/no-image.jpg') }}@endif" id="preview_{{ $component_id }}" alt="" width="100%">
                    <div class="custom-file">
                        ...
                        <input type="hidden" name="bg_file_{{ $component_id }}" data-name="bannerImage" value="{{ $content->value[0]->image }}">
                    </div>
                </div>
