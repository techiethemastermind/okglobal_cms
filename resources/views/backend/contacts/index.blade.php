                    ...
                    <table class="table table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <a href="#" class="text-muted list-sort" data-sort="tables-name">Name</a>
                                </th>
                                <th scope="col">
                                    <a href="#" class="text-muted list-sort" data-sort="tables-email">Email</a>
                                </th>
                                <th scope="col">
                                    <a href="#" class="text-muted list-sort" data-sort="tables-subject">Subject</a>
                                </th>
                                <th scope="col">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td class="tables-name">{{ $contact->name }}</td>
                                <td class="tables-email">{{ $contact->email }}</td>
                                <td class="tables-subject">{{ $contact->subject }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('admin.contact.edit', $contact->id) }}" data-type="detail" class="dropdown-item">
                                                Detail
                                            </a>
